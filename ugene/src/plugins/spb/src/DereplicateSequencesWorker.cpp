...
static const QString REPORT_URL_ATTR_ID("report-url");
...
void DereplicateSequencesWorker::init() {
    ...
    reportUrl = actor->getParameter(REPORT_URL_ATTR_ID)->getAttributeValue<QString>(context);
}
...
Task * DereplicateSequencesWorker::tick() {
    ...
    if (inPort->isEnded()) {
        ...
        Task *t = DereplicationTaskFactory::createTask(derepAlgoId, data, reportUrl);
        if (NULL == t) {
...
void DereplicateSequencesWorkerFactory::init() {
    ...
    QList<Attribute*> attrs;
    {
        ...
        Descriptor accD(ACCURACY_ATTR_ID,
            ...
            DereplicateSequencesWorker::tr("Comparing accuracy."));
        Descriptor repD(REPORT_URL_ATTR_ID,
            DereplicateSequencesWorker::tr("Report url"),
            DereplicateSequencesWorker::tr("Report url."));
        ...
        attrs << new Attribute(repD, BaseTypes::STRING_TYPE(), true, "");
    }
    ...
    QMap<QString, PropertyDelegate*> delegates;
    {
        ...
        delegates[REPORT_URL_ATTR_ID] = new URLDelegate("", "");
    }
