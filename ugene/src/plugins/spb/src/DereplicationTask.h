...
public:
    DereplicationTask(const QString &taskName, const DereplicationData &data, const QString &reportUrl);
...
public:
    static DereplicationTask *createTask(const QString &taskId, const DereplicationData &data, const QString &reportUrl);
